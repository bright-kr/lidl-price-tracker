...
Info  : https://brightdata.co.kr/products/insights/price-tracker/lidl
"""
...
# https://brightdata.co.kr/products/web-scraper/lidl
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Lidl scraper at: https://brightdata.co.kr/products/web-scraper/lidl\n"
